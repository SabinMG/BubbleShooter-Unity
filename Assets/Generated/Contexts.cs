...
public partial class Contexts {
    ...
    public const string HexCell = "HexCell";

    [Entitas.CodeGeneration.Attributes.PostConstructor]
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>(
            HexCell,
            game.GetGroup(GameMatcher.HexCell),
            (e, c) => ((HexCellComponent)c).coordinate));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithHexCell(this GameContext context, UnityEngine.Vector2Int coordinate) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, UnityEngine.Vector2Int>)context.GetEntityIndex(Contexts.HexCell)).GetEntity(coordinate);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
